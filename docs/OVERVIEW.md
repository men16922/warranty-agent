...
> T2-2(배포) → T3(계약 방출). 그전까지 오프라인으로 가능한 건 **REQ-508** 하나뿐이다
> (REQ-404 · REQ-405는 2026-08-21에 끝났다).
...
요구사항  44종 — VERIFIED 16 · IMPLEMENTED 14 · TODO 14
가드      G1~G4 · G6~G9 변이 확인 · G5만 미착수
변이      M-01~M-29 전부 red 확인 · 복구 후 초록 · 잔여 0
...
⚠️ **남은 14개 TODO 중 13개가 실물 GCP를 요구한다.** 오프라인으로 더 갈 수 있는 것은
REQ-508(회복률 리포트) 하나뿐이다 — 그것을 해도
