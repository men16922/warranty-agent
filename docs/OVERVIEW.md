...
> T2-2(배포) → T3(계약 방출). 그전까지 오프라인으로 가능한 건 **REQ-804** 하나뿐이다
> (REQ-404 · REQ-405 · REQ-508 · REQ-603 · REQ-803은 2026-08-21에 끝났다).
...
지금 남은 것은 T6-3(REQ-804) **하나**이고,
**그것을 해도 중단 기준의 판정 대상(T2-2)은 움직이지 않는다.**
