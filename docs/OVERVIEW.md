...
> T2-2(배포) → T3(계약 방출). 그전까지 오프라인으로 가능한 건 **REQ-603 · REQ-803 · REQ-804**
> 셋뿐이다 (REQ-404 · REQ-405 · REQ-508은 2026-08-21에 끝났다).
...
요구사항  44종 — VERIFIED 17 · IMPLEMENTED 14 · TODO 13
...
지금 남은 셋은 T5-3(REQ-603) · T6-2(REQ-803) · T6-3(REQ-804)이고,
**셋을 다 해도 중단 기준의 판정 대상(T2-2)은 움직이지 않는다.**
