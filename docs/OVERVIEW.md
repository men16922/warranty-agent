...
> T2-2(배포) → T3(계약 방출). 그전까지 오프라인으로 가능한 건 **REQ-508 · 404 · 405** 셋뿐이다.
...
변이      M-01~M-25 전부 red 확인 · 복구 후 초록 · 잔여 0
...
⚠️ **남은 16개 TODO 중 13개가 실물 GCP를 요구한다.** 오프라인으로 더 갈 수 있는 것은
REQ-508(회복률 리포트) · REQ-404(승인) · REQ-405(예약) 셋뿐이다 — 그 셋을 다 해도
