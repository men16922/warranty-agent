...
- [ ] [auto] **T11-5** README 재현 절차 집행 · `Implements: REQ-901`
      README가 적은 명령이 **실재하는 make 타깃인가**. ⛔ `make demo`가 죽어 있던 전례가 있다.
      `Done:` 없는 명령을 적으면 red + 변이 확인.
...
**게이트**: `make check` → **185 passed** (2026-08-22 로컬 macOS·py3.13)
